...
Freight transportation problem is an important issue in our daily lives [1]. With the development of transportation technology, the customers have the higher expectation on more efficient and more rapid delivery service. Besides, as the self-driving car technology grows [2], the self-driving vehicle delivery begins to be a crucial research topic. After reviewing the self-driving car delivery market, there is no complete self-driving delivery system. 
...
%------------------------- Related Works -------------------------%
\cite{Anand2012} proposed a method
