...
%% [11]
JD.com, which is the largest e-commence platform by revenue, used autonomous driving vehicles to hit the open road in Beijing \cite{Delivery2017}. The vehicle can store up to thirty containers, and travel 15 km/hr. The current concerns of the approach are the autonomous driving technology and government regulations.
...
%% [13]
Dresden University of Technology introduced the real-time I/O data interface and proposed an approach to \textbf{building up a Web service} \cite{10.1007/978-3-662-45079-6_5}. 
...
%% [14]
Heng Tat Hong showed the \textbf{transportation simulation for food distribution} \cite{Tunku2016}. The author used TraaS to assign trucks backup when the original tricks unable to cover the destination shops at certain time threshold, and re-route the path for the backup vehicles.
...
To build a vehicle dispatching and monitoring system, the thesis implements two components, which includes SUMO simulator and SUMO server. According to the concept of web service from Dresden University of Technology \cite{10.1007/978-3-662-45079-6_5}, the thesis improved the architecture of web service to meet the demands of Android client.
