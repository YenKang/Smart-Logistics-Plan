...
Besides, I am really grateful to Professors Hewijin Christine Jiau, Ye-Qi Wu, and Wei-Zong Hu for not only their contributions to the research but also serving on my dissertation committee.
...
First stage is box filtering stage, where the vehicle with more than one available container is qualified to enter into the second stage named as a simple time scheduling stage. Next, the second stage would judge whether the order can be inserted into the original time schedule or not. Moreover, the thesis demonstrates that the dispatching mechanism is applied to the scenario of the sender and the receiver.
