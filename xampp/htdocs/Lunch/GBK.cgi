...
# 設定留言板的 URL 位址
$gbkurl="140.116.72.134/Lunch/gbk.php";
...
foreach $line(@all) {
   ...
   if ($line =~ /<!--ols3-->/)  {
    ...
    # 寫回原來的標記, 以後方可繼續使用
     ...
     # 寫入新的留言
      print FHD "姓名: $name 年齡: $age [時間: $date]<p><XMP> $comment </XMP><hr size=1>\n";
...
print "<html><head>\n";
print "<META HTTP-EQUIV=REFRESH CONTENT=\"3;URL='gbk.php'\" charset=utf-8>\n";
