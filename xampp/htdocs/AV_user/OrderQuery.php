<?php
	...
	$statement = mysqli_prepare($con, "SELECT * FROM user_order WHERE sender_name = ? OR receiver_name = ?")or die(mysqli_error($con));
	mysqli_stmt_bind_param($statement, "ss", $user_name, $user_name);
