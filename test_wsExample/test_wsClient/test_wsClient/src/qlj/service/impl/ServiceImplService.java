 ...
 * 
 */
@WebServiceClient(name = "ServiceImplService", targetNamespace = "http://impl.service.qlj/", wsdlLocation = "http://127.0.0.1:9092/test?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.qlj/", "ServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:9092/test?wsdl");
    ...
    public ServiceImpl getServiceImplPort() {
		System.out.println("line 72 at ServiceImplService.java");
        return super.getPort(new QName("http://impl.service.qlj/", "ServiceImplPort"), ServiceImpl.class);
    }
    ...
    public ServiceImpl getServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.qlj/", "ServiceImplPort"), ServiceImpl.class, features);
    }
