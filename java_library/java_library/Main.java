...
public class Main {
	...
	// 在測一次
	static String sumo_bin = "C:\\Program Files (x86)\\Eclipse\\Sumo\\bin\\sumo-gui";
	// static String config_file = "simulation/map.sumo.cfg";
	// static String config_file = "simulation_Tainan/map_from_flow.sumo.cfg";

	

	static String config_file = "C:\\Users\\PusheenZ\\Desktop\\java_library\\java_library\\simulation4\\map.sumo.cfg";
		...
		try {
			...
			for (int i = 0; i < 360000; i++) {
				...
				if(timeStep==20.0) {
					...
					/* boxIndex initialization of setParameter
					for(int q=1;q<31;q++) {
